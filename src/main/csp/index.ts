...
export const CaptchaSrc = [...CSPSrc, "script-src"];
...
export const CspPolicies: PolicyMap = {
    ...
    "hcaptcha.com": CaptchaSrc,
    "*.hcaptcha.com": CaptchaSrc,
    "recaptcha.net": CaptchaSrc,
    "*.recaptcha.net": CaptchaSrc,
    "google.com": CaptchaSrc,
    "*.google.com": CaptchaSrc,
    "gstatic.com": CaptchaSrc,
    "*.gstatic.com": CaptchaSrc,
    "challenges.cloudflare.com": CaptchaSrc,
};
